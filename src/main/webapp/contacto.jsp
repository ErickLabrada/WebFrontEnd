...
<body>
    ...
    <div class="container-fluid py-5" style="background-color: #FFD95A;">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Cont�ctanos</h1>
            <p>
                Puedes asistir a nuestra tienda de abarrotes situada en Blvd Camino Real #250, o puedes mandarnos un correo electr�nico llenando el siguiente formulario.
            </p>
        </div>
    </div>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto" method="mailto:dymas-@hotmail.com" role="form">
                ...
                <div class="mb-3">
                    <label for="inputsubject">T�tulo</label>
                    <input type="text" class="form-control mt-1" id="subject" name="subject" placeholder="T�tulo">
                </div>
                <div class="mb-3">
