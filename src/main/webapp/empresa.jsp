        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-black">
                    ...
                    <p>
                        Boutique Dimas, no es solo una tienda, ¡es el centro de la organización y la comida! Imagina un
                        lugar donde puedes encontrar desde el lápiz más puntiagudo hasta la lata de frijoles más
                        deliciosa.
                        Las cradoras y organizadoras, mantienen un establecimiento donde cada artículo cumple con tus
                        aspectativas. ¡Ven a Boutique Dimas, donde comprar es una aventura!
                    </p>
                </div>
                <div class="col-md-4">
