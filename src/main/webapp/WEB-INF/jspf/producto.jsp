...
<div class="col-md-4">x
    <div class="card mb-4 product-wap rounded-0">
        ...
        <div class="card-body">
            <a href="shop-single.html" class="h3 text-decoration-none"><%= request.getAttribute("nombre_producto") %></a>                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                <li class="pt-2">
                    <span
