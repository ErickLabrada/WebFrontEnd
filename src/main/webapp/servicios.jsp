        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-black">
                    ...
                    <p>
                        <br>
                        Encuentra todo lo que necesitas para el trabajo y el estudio en nuestra sección de papelería. Desde lápices y bolígrafos hasta material de oficina personalizado. En nuestra sección de papelería, te ofrecemos mucho más que simples suministros de oficina. Es el lugar donde la creatividad se encuentra con la funcionalidad, proporcionándote todo lo necesario para expresarte y tener éxito en tus proyectos.
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                ...
                <div class="col-md-8 text-black">
                    ...
                    <p>
                        <br>
                        Descubre las últimas tendencias de moda y estilo en nuestra boutique. Desde ropa elegante y accesorios hasta calzado de moda, te ayudaremos a encontrar el look perfecto para cualquier ocasión. Además, nuestro equipo de expertos en moda está aquí para brindarte asesoramiento personalizado y garantizar que te veas y te sientas increíble.
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-black">
                    ...
                    <p>
                        <br>
                        No te pierdas la oportunidad de ganar premios emocionantes en nuestros sorteos y rifas! Participa para tener la oportunidad de llevarte a casa increíbles regalos, descuentos especiales y mucho más. Es nuestra manera de agradecer tu apoyo y fomentar la diversión y la emoción entre nuestra comunidad de clientes.
